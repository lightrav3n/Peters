...
<div style="text-align: center;">
    <table align="center"
        ...
        <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 15px; padding-bottom: 15px;"
                width="596">
                <img
                    style="width: 200px; max-width: 200px; height: 75px; max-height: 75px; text-align: center; color: #ffffff;"
                    alt="Logo" src="{{asset('assets/img/logo/bodenprobetechnik_logo_vector.svg')}}" align="center"
                    width="200" height="75">
            </td>
        </tr>
        </tbody>
    ...
    <table align="center"
        ...
        <tr style="background:#efefef">
            <th scope="col" width="30%" style="text-align:left;border:1px solid #eee">Products</th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                ...
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                    Vielen Dank für Ihre Anfrage. Wir freuen uns über Ihr Interesse und setzen uns kurzfristig mit Ihnen in Verbindung.
                </p>
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                    Ihr Team der Bodenprobetechnik Peters GmbH.
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;"
                ...
                <p style="font-size: 13px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #ffffff;">
                    Bahnhofstraße 36, D-49635 Badbergen
                </p>
