    ...
    <div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                <div class="card-body">
                    <form id="formtest" class="row g-3" method="post" action="{{route('Partners.update', $partner)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="col-md-6">
                                                    ...
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="width-8 h-auto rounded-3">
                                                            <img width="150px" height="150px" class="img-fluid rounded-3 block"
                                                                 src="{{$partner->getFirstMediaUrl($partner->collection_name)}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 mt-5">
                            <button id="upload" type="submit" class="btn btn-primary">Edit Partner</button>
                        </div>
                    </form>
                </div>
            </div>
