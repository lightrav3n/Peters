    ...
    <div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                <div class="card-body">
                    <form id="formtest" class="row g-3" method="post" action="{{route('Partners.store')}}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="dropzone border-0 bg-body rounded-3 bg-opacity-25">
                                        <div class="fallback">
                                            <input id="posterImage" name="logo" type="file" onchange="previewPoster(event)">
                                            <h4 class="fw-bold text-center">Partner Logo here.</h4>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 mt-5">
                            <button id="upload" type="submit" class="btn btn-primary">Add Partner</button>
                        </div>
                    </form>
                </div>
            </div>
