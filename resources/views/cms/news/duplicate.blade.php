        ...
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="mb-1">Duplicate news {{$activity->title}}</h5>
                </div>
                <div class="card-body">
                    <form id="formtest" class="row g-3" method="post" action="{{route('News.duplicate.store', $activity)}}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="col-md-3">
                                                    ...
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="width-8 h-auto rounded-3">
                                                            <img width="150px" height="150px" class="img-fluid rounded-3 block"
                                                                 src="{{$activity->getFirstMedia($activity->poster_image_collection)->getUrl('thumb340')}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 mt-5">
                            <button id="upload" type="submit" class="btn btn-primary">Duplicate Save</button>
                        </div>
                    </form>
                </div>
            </div>
