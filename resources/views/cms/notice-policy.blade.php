        ...
        <div class="position-relative container-fluid px-0">
            <div class="row align-items-center position-relative">
                <div class="col-md-8 mb-4 mb-md-0">
                    <h3 class="mb-2">Site Notice</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{route('cms.index')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Site Notice</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    @foreach($privacy as $language)
                        <div class="card mb-3 mb-lg-5 card-body">
                            <form method="post" action="{{route('cms.notice.update')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="col-12 my-3">
                                        <label for="description" class="form-label">Description of Site Notice page {{$language->display_name}}</label>
