        ...
        <div class="position-relative container-fluid px-0">
            <div class="row align-items-center position-relative">
                ...
                <div class="col-md-4 text-md-end">
                    <a href="{{route('Download.create')}}" class="btn btn-success">
        ...
        <div class="row">
            <div class="card table-card table-nowrap overflow-hidden card-table">
                <div class="card-header d-flex align-items-center">
                    <h5 class="mb-0 pe-3 flex-grow-1 text-truncate">List Brochures</h5>
                </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <p class="h6 mb-1">{{$brochure->name}}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <a href="{{route('Download.edit', $brochure)}}" class="btn btn-light btn-sm">
                                    <span class="material-symbols-rounded align-middle">
                                      edit
                                      </span>
                                    </a>
                                    <form class="d-inline" method="post" action="{{route('Download.destroy', $brochure)}}">
                                        @csrf
                                        @method('DELETE')
