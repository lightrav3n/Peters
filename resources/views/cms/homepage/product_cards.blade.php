        ...
        <div class="position-relative container-fluid px-0">
            <div class="row align-items-center position-relative">
                <div class="col-md-8 mb-4 mb-md-0">
                    <h3 class="mb-2">Home Product Cards</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Home Product Cards</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                @foreach($cards as $card)
                    <div class="col-4">
                        <div class="card mb-3 mb-lg-5 card-body">
                            ...
                            <form id="formtest" class="row g-3" method="post" action="{{route('cms.homepage.productcards.update', $card)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="col-md-12">
